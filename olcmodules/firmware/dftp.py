        ...
        if self._lpath_isdir:
            for file_name in os.listdir(self._lpath):
                ...
                if file_name == 'sd' and os.path.isdir(file_path):
                    for file_iname, file_info in list(self._device_profile['firmware']['file_info'].items()):
    ...
    def get_file_paths(self):
        try:
            ...
            for fw_lfile in self._local_file_list:
                for file_name, file_info in list(self._device_profile['firmware']['file_info'].items()):
